                    ...
                    <template #default>
                        <div class="flex-between-center p-x-30 m-t-10">
                            ...
                            <el-popover placement="right" title="用户名" :width="200" trigger="click" content="由5-12位的数字或字母组成">
                                <template #reference>
                                    <el-input v-model="registerForm.account" style="width: 300px" placeholder="Please input" clearable />
                                </template>
                            </el-popover>
                        </div>
                        <div class="flex-between-center p-x-30 m-t-10">
                            ...
                            <el-popover placement="right" title="密码" :width="200" trigger="click" content="由开头不能为数字的6-12位的数字或字母组成">
                                <template #reference>
                                    <el-input v-model="registerForm.password" style="width: 300px" type="password" show-password placeholder="Please input" clearable />
                                </template>
                            </el-popover>
                        </div>
                        <div class="flex-between-center p-x-30 m-t-10">
                            <span>确认密码：</span>
                            <el-input v-model="registerForm.cpassword" style="width: 300px" type="password" show-password placeholder="Please input" clearable />
                        </div>
                    </template>
                    <template #footer>
